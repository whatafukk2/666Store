    ...
    with get_db() as db:
        ...
        products = [
            (
                ...
                "Футболка «Божество»",
                "tshirt",
                "Авторский принт 666 Store, плотный хлопок и качество, которое сразу чувствуется.",
                999,
                24,
                120,
            ),
            (
                "tshirt-pvp-life",
                "Футболка «ПВП — моя жизнь»",
                "tshirt",
                "Вещь для тех, кто живет в режиме ПВП. Хлопок, удобная посадка и уникальный вайб.",
                1099,
                27,
                135,
            ),
            (
                "tshirt-king-ht1",
                "Футболка «Король ХТ1 игроков»",
                "tshirt",
                "Дизайн для тех, кто не просто играет, а забирает статус короля ХТ1 игроков.",
                1199,
                29,
                150,
            ),
            (
                ...
                "Худи «666 Store»",
                "hoodie",
                "Теплое хлопковое худи с темной эстетикой 666 и максимальным качеством за свою цену.",
                2499,
                61,
                310,
            ),
